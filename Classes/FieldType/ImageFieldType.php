...
namespace AutoDudes\Sitepackage\FieldType;
 ...
 */
#[FieldType(name: 'Image', tcaType: 'file')]
final class ImageFieldType extends AbstractFieldType
{
    use WithCommonProperties;

    private array|string $allowed = 'common-image-types'; // what I changed
    ...
    public function createFromArray(array $settings): ImageFieldType
    {
        $self = clone $this;
